...
<section class="container col-8">
    ...
    @endif
    <form class="container mt-2 bg-white" method="post" enctype="multipart/form-data" action="product_insert">
        @csrf
        ...
        <h1 class="py-4 ml-3"><i class="fa fa-plus" aria-hidden="true"></i> Add Product</h1>
