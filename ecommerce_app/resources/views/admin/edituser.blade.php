@extends('admin.dashboard')
    ...
    @endif
    <form class="container mt-2 bg-white" method="post" action="/update_user">
        @csrf
        ...
        <h1 class="py-4 ml-3"><i class="fa fa-edit"></i> Edit User</h1>
         <div class="form-group">
            ...
            @enderror
            <input type="text" class="form-control" value="{{$data->first_name}}" name="first_name" placeholder="First Name" >
         </div>
         <div class="form-group">
            ...
            @enderror
            <input type="text" class="form-control" value="{{$data->last_name}}" name="last_name" placeholder="Last Name" >
         </div>
         <div class="form-group">
            <label>Email</label>
            @error('email')
